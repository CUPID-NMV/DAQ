...
def plot_waveform_h(waveform, lenw, pmt, event_number, event_time):
    import numpy as np
    import math
    npx = math.ceil(pmt/2)
...
def main(grid=False, pmt_f=DEFAULT_PMT_FAST_VALUE, verbose=False):
    # Create our client
        ...
        try:
            ...
            for bank_name, bank in event.banks.items():
                ...
                if bank_name=='DGH0': 
                    ...
                    plot_waveform_h(waveform, lenw, int(pmt_f), event_number, event_time)
